...
import { Calendar, CalendarDays, Clock, MapPin, Search, Share2 } from "lucide-react";
            ...
            <Card key={month} className="bg-zinc-900 border-zinc-800">
              <CardHeader className="py-3 px-4 border-b border-zinc-800">
                <div className="flex items-center justify-between">
                  <CardTitle className="text-base font-medium text-zinc-100">{month}</CardTitle>
                    ...
                    {events.map((event) => (
                      <button
                        ...
                        className="w-full text-left p-3 rounded-lg bg-zinc-800 hover:bg-zinc-700 
                          border border-zinc-700 transition-colors duration-200 group"
                      >
                        <div className="space-y-2">
              ...
              <div className="mt-6 space-y-6">
                <div className="space-y-4">
                  <div className="flex items-center gap-3 text-zinc-300">
                    ...
                    <div>
                      <p className="text-sm">{dayjs(selectedEvent.date).format("DD MMMM YYYY")}</p>
                ...
                <div className="pt-4 border-t border-zinc-800">
                  <button className="w-full flex items-center justify-center gap-2 py-2 px-4 rounded-lg 
